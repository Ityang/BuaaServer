...
public class Validator {
	...
	//是否是日期格式
	private static final String validDate = "^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])))))|(\\d{2}(([02468][1235679])|([13579][01345789]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\\s(((0?[0-9])|([1-2][0-3]))\\:([0-5]?[0-9])((\\s)|(\\:([0-5]?[0-9])))))?$";
	...
	public static boolean isNull(String str) {
		if (null == str || str.trim().isEmpty() || str.trim().equals(StringUtil.NULL)) {
			return true;
		}
		return false;
	}
	 ...
	 *
	 * @param  str 传入的字符串
	 * @return     如果str是符合日期格式则为true，否则为false
	 */
	public static boolean isValidDate(String str) {
		boolean flag = isEqualString(str, validDate);
		return flag;
	}
